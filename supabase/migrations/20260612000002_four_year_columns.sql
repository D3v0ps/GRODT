-- ============================================================
-- GRODT – list_leads v3: fyra omsättningskolumner (t.ex. 2021–2024)
--
-- Bolagslistan visar nu ett fönster om fyra räkenskapsår. Tillväxten
-- beräknas mellan de två senaste (= kvalificeringsåren i Inställningar).
-- ============================================================

drop function public.list_leads(text, text, text, uuid, bigint, bigint, integer, integer, numeric, text, text, integer, integer);
